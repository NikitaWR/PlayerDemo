...
import static com.example.nikita.playerdemo.SQLAdapter.Audios.COLUMN_NAME_ARTPATH;
...
public class SQLAdapter {
    ...
    public long createAudio(String data, String title, String album, String artist, String artPath) {
    ...
    public Cursor fetchAllAudios() {
        Cursor mCursor = mDb.query(Audios.TABLE_NAME, new String[]{Audios._ID, COLUMN_NAME_DATA,
                Audios.COLUMN_NAME_ARTIST, Audios.COLUMN_NAME_TITLE,Audios.COLUMN_NAME_ALBUM, Audios.COLUMN_NAME_ARTPATH}, null, null, null, null, orderBy, null);
        if (mCursor != null) {
            mCursor.moveToFirst();
        }
    ...
    public Cursor fetchAudiosByTitleAndArtist(String inputText) throws SQLException {
        ...
        mCursor = mDb.query(Audios.TABLE_NAME, new String[]{Audios._ID, COLUMN_NAME_DATA,
                        Audios.COLUMN_NAME_ARTIST, Audios.COLUMN_NAME_TITLE,Audios.COLUMN_NAME_ALBUM,Audios.COLUMN_NAME_ARTPATH},
